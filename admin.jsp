...
<c:set var="mainPage" value="admin.jsp" scope="page" />
...
<div class="page-footer">
	<div class="page-footer-inner">
		2015 &copy; CodePamoja. <a href="http://codepamoja.org">odePamoja.</a> All Rights Reserved
	</div>
...
<% } %>
	...
	function navButtonAction(){
		var selRow = jQuery("#jqlist").jqGrid('getGridParam', 'selrow');
		toastr.options = {
                    "closeButton": true,
                    "debug": false,
                    "positionClass": "toast-top-right",
                ...
                if(selRow == null){
                	...
                	var data = jQuery("#jqlist").jqGrid('getRowData',selRow);
                	//console.info(data);
                    
                	var user_id = data.user_name;
                	var test_id = data.aptitude_test_id ;
                    
                    var url = "http://"+ window.location.host +"/aptitude/check.jsp?user_name="+user_id+"&test_id="+test_id;
                    window.open(url, '_blank');
                	console.info('user_name : ' + user_id + '\ntest_id : ' + test_id);
                    
                	/*$('#modalPreview').modal({ keyboard: false });*/
